...
age_distribution_palette <- "mordor"
alpha = 0.5
size = 2
linetype = 2
nudge_y = 0.02
...
ratio_obesity_disease_prevalence <-
  ...
  labs( # the rest is just aesthetics and making the plot more clean + readable
    title = "Obesity Disease Prevalence by Income Ratio", 
    x = "Income Ratio", 
    y = "Obesity Disease Prevalence"
  ) +
  theme( 
...
education_obesity_disease_prevalence <-
  ...
  labs( # the rest is aesthetics + cleanup
    title = "Obesity Disease Prevalence by Education Level", 
    x = "Obesity Education Level", 
    y = "Obesity Disease Prevalence"
  ) +
  theme(
    text = element_text(size = 8), 
...
income_obesity_disease_prevalence <-
  ...
  labs( # use the same labels + theme format, for consistency
    title = "Obesity Disease Prevalence by Income", 
    x = "Income", 
    y = "Obesity Disease Prevalence"
  ) +
  theme(
